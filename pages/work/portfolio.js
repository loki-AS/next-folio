  ...
  return (
    <div className='bg-[#eee7e1] h-full w-full sm:px-16 px-6'>
        ...
        <div className='px-5 pb-10'>
            ...
            <a className='text-md font-poppins py-4 text-gray-700 tracking-[2px] hover:underline' href="https://loki-portfolio.netlify.app/">https://loki-portfolio.netlify.app/</a>
        </div>
